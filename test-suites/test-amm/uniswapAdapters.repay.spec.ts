...
//     beforeEach(async () => {
//       const { users, weth, dai, usdc, stlos, pool, deployer } = testEnv;
...
//       await stlos.mint(parseEther('1000000'));
//       await stlos.approve(pool.address, parseEther('1000000'));
//       await pool.deposit(stlos.address, parseEther('1000000'), deployer.address, 0);
...
//       await stlos.mint(parseEther('1000000'));
//       await stlos.approve(pool.address, parseEther('1000000'));
//       await pool.deposit(stlos.address, parseEther('1000000'), userAddress, 0);
