...
contract UniswapRepayAdapter is BaseUniswapAdapter {
   ...
   * The user should give this contract allowance to pull the OTokens in order to withdraw the underlying asset, swap it
   ...
   * The user should give this contract allowance to pull the OTokens in order to withdraw the underlying asset
  ...
  function swapAndRepay(
    ...
    if (collateralAsset != debtAsset) {
      ...
      // Pull oTokens from user
      _pullOToken(
        collateralAsset,
        collateralReserveData.oTokenAddress,
        msg.sender,
        amounts[0],
        permitSignature
      );
