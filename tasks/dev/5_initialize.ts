...
import { tEthereumAddress, MeridianPools, eContractid } from '../../helpers/types';
...
task('dev:initialize-lending-pool', 'Initialize lending pool configuration.')
  ...
  .setAction(async ({ verify, pool }, localBRE) => {
    ...
    const testHelpers = await deployMeridianProtocolDataProvider(addressesProvider.address, verify);
