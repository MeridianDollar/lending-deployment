...
export const CommonsConfig: ICommonConfiguration = {
  MarketId: 'Commons',
  OTokenNamePrefix: 'Meridian XDAI Market',
  StableDebtTokenNamePrefix: 'Meridian XDAI Market stable debt',
  VariableDebtTokenNamePrefix: 'Meridian XDAI Market variable debt',
  SymbolPrefix: 'm',
