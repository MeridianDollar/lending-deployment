...
export const CommonsConfig: ICommonConfiguration = {
  MarketId: 'Commons',
  OTokenNamePrefix: 'Meridian Avalanche Market',
  StableDebtTokenNamePrefix: 'Meridian Avalanche Market stable debt',
  VariableDebtTokenNamePrefix: 'Meridian Avalanche Market variable debt',
  SymbolPrefix: 'v',
  ...
  ChainlinkAggregator: {
    [eAvalancheNetwork.avalanche]: {
      ...
      STLOS: '0x3CA13391E9fb38a75330fb28f8cc2eB3D9ceceED',
